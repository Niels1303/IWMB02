...
public class FoodFragment extends Fragment {
    ...
    private String selectedFood, objectId;
    ...
    public void updateTeilnehmer() {
        ...
        tnmr.setSelectedFood(selectedFood); //Nur das "selectedFood" Attribut des "Teilnehmer" Objekts wird bestimmt. Die leeren Attribute werden in der DB nicht verändert.
        NetworkService.getInstance()
                .getRestApiClient()
    ...
    public void checkScore() {
        ...
        for(int i=0; i < teilnehmer.length; i++) {
            if(spieltermine.get(counter).getObjectId().equals(teilnehmer[i].getSpielterminId().getObjectId()) && teilnehmer[i].getSelectedFood() != null) { //Es werden nur die Essensrichtungsauswahl des angezeigten Datums der Liste hinzugefügt bzw. angezeigt.
                lst.add(teilnehmer[i].getSelectedFood());
            }
        }
        //sortiert die ArrayList in einem LinkedHashSet welche Essensrichtungen wie oft vorkommen.
